...
st.title("Terms")
st.write("Last updated: 2023-02-23")
...
##### 4. Feedback  \n
We value your feedback on GPT Lab and appreciate any comments, suggestions, or ideas you may have for improving our platform ("Feedback"). By providing Feedback, you grant us a non-exclusive, transferable, worldwide, perpetual, irrevocable, fully-paid, royalty-free license, with the right to sublicense, to use, copy, modify, create derivative works based upon, and otherwise use the Feedback for any purpose. You acknowledge that your Feedback does not contain any confidential or proprietary information belonging to you or any third party. While we welcome your Feedback, you agree that we are not obliged to act on any Feedback you provide. You also agree to indemnify and hold GPT Lab and its affiliates, officers, agents, employees, and licensors harmless from any claim or demand, including reasonable attorneys’ fees, made by any third party due to or arising out of your Feedback, as set forth in the Indemnification section below.

##### 5. Privacy Policy  \n
At GPT Lab, we take your privacy very seriously. Our application only uses your OpenAI API Key during sessions to interact with the AI models. To ensure your confidentiality and security, we use a one-way hashing algorithm on your OpenAI Key to generate your unique user identity rather than collecting or storing Personal-Identifiable-Information (PII). We do store the AI assistant prompts and user chat session messages, which can be reviewed and audited periodically to ensure no misuse. For more information about our privacy practices, please visit our privacy policy.
...
As discussed in the User Content section, you agree not to provide any PII or PHI to the AI Assistants during these sessions. Please be aware that your session messages are transmitted to OpenAI's models and are recorded on our server (even though your user identifier is not tied to you). While we take appropriate measures to secure your information, we cannot guarantee the absolute security of your data. Therefore, we recommend that you do not provide any sensitive or confidential information during the chat sessions. By using the AI Assistants on our platform, you acknowledge and accept these risks. You also agree to indemnify and hold GPT Lab and its affiliates, officers, agents, employees, and licensors harmless from any claim or demand, including reasonable attorneys’ fees, made by any third party due to or arising out of any chat sessions you participate in or any decisions you make based on the AI Assistants, as set forth in the Indemnification section below. 
...
Your AI Assistant Prompts and your chat session messages are transmitted and processed by OpenAI. We store both on our servers, but they are only tied to your anonymized user identifier, generated from the hashed value of your OpenAI API Key. While we have Terms specifying what types of AI Assistants can be created and Terms prohibiting inclusion of PII and PHI in creating chat session messages, inadvertently, some may still leak through. We take appropriate measures to secure your information by storing them with reputable vendor (Google Cloud) and limit access to only authorized personnel. These prompts and messages may be reviewed/audited periodically to ensure no misuse. The session messages may also be used in the future to improve the product.
